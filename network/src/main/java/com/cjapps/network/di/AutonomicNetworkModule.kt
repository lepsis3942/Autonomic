...
open class AutonomicNetworkModule {
    ...
    internal fun provideRetrofit(applicationContext: Context): Retrofit {
    ...
    @Provides
    @Reusable
    internal fun provideAutonomicService(@Named(AUTONOMIC_RETROFIT_NAME) retrofit: Retrofit): AutonomicApiService {
